	...
	<div class="container">
		...
		<?php
			...
			!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
						...
						echo '<div class="zerif-copyright-box"><a class="zerif-copyright" href="http://garlandtenniscenter.com"'.$attribut_new_tab.' rel="nofollow">JCTC </a>'.__('powered by','zerif-lite').'<a class="zerif-copyright""'.$attribut_new_tab.' rel="nofollow"> City of Garland</a></div>';
